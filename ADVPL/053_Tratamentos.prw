//----------------------------------------------------------------------------------------------------------------//
// Funcoes de tratamento e conversoes de caracteres, numeros e datas.
// Colocar um breakpoint no Return
// Para testar, executar a funcao pelo IDE, copiar cada um dos exemplos, colar em Comandos e ver o resultado.
// Copiar só até a flechinha -> 
// Para executar em Comandos basta posicionar o cursor na linha
//----------------------------------------------------------------------------------------------------------------//
